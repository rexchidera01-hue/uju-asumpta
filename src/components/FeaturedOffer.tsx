      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 items-center gap-8 sm:gap-12 md:gap-16 px-4 sm:px-6">
        ...
        <div className="md:col-span-7 lg:col-span-6">
          ...
          <h2
            ...
            className="mt-2 sm:mt-3 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold leading-tight text-gray-900"
          >
          ...
          <div className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl space-y-2 sm:space-y-3 text-gray-800">
            <p>
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl font-semibold italic text-gray-800">
            Learn what the world never taught you.
          </p>

          <div className="mt-6 sm:mt-8 flex items-start">
            <a
              href="/curriculum"
