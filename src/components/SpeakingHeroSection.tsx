...
import heroImage from "../assets/speaking-img.jpeg"; // ← your single image here
...
const QUOTES = [
  ...
  {
    text: "Legacy is love arranged to outlive you.",
    author: "Uju Asumpta",
  },
];
...
export default function SpeakingHeroSection() {
  ...
  // Sync quote when tab becomes visible again
  useEffect(() => {
  ...
  // Mobile menu keyboard + scroll lock
  useEffect(() => {
    ...
    <>
      ...
      <header className="bg-gray-50 text-black py-4 sm:py-6 md:py-8">
        <div className="flex items-center justify-between px-4 sm:px-6 md:px-10">
          ...
          {/* DESKTOP NAV – all internal, so all <Link> */}
      ...
      {/* HERO SECTION – single fixed image, quotes hidden on mobile */}
      <section
      ...
      >
        ...
        <img
          src={heroImage}
          alt="Inspirational scene representing voice, truth, and impact"
        ...
        {/* Quote carousel – hidden below md (768px), visible on desktop */}
